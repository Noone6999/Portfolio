...
const Skills = () => {
  return (
    <div name='skills' className='w-full md:h-screen bg-[#FFF] text-[#20BCFC]'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div>
              <p className='text-4xl font-bold inline border-b-4 border-[#FEDE4F] '>Skills</p>
              <p className='py-4 pb-0'>// These are the technologies I've worked with</p>
          </div>
